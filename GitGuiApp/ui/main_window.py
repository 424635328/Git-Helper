...
from PyQt6.QtCore import Qt, pyqtSlot, QSize, QTimer, QModelIndex, QUrl, QPoint, QItemSelection, QRect
    ...
    def _update_ui_enable_state(self, enabled: bool):
        for widget in self._repo_dependent_widgets:
            if widget:
                 ...
                 widget.setEnabled(enabled and is_repo_valid)
        ...
        if sequence_str:
            ...
            for cmd in commands:
                 try:
                      ...
                      self.current_command_sequence.append(cmd)
